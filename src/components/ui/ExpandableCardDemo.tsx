...
const cards = [
  ...
  },
  {
    ...
    title: "Benefits",
    src: "https://i.postimg.cc/sxCP0hnF/DSC08482.jpg",
    ctaText: "Expand",
    ctaLink: "https://ui.aceternity.com/templates",
    content: () => {
      return (
...

  {
    ...
    content: () => {
      return (
        <p>
          Convenience meets sophistication as Pro Box is strategically located in City Center Garhoud, providing
  ...
  },
  {
    ...
    content: () => {
      return (
        <p>
         At Pro Box, our mission is to create vibrant and flexible workspaces 
